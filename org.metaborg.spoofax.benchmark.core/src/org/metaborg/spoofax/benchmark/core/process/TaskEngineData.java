...
public final class TaskEngineData implements Serializable {
	...
	public final Multiset<String> numTaskKinds = HashMultiset.create();
	
	public final MathLongList delays = new MathLongList();
	public final Map<String, MathLongList> delaysPerKind = Maps.newHashMap();
