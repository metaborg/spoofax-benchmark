...
public final class Facade {
    ...
    public CollectedData collect(String languageDir, String languageName, String projectDir, int warmupPhases,
        ...
        final DataCollector collector = new DataCollector(languageDir, languageName, projectDir, termFactory);
        return collector.collect(warmupPhases, measurementPhases);
    }

    public void serializeCollected(CollectedData data, FileObject serializeDirectory) throws IOException {
    ...
    public void collectAndSerialize(String languageDir, String languageName, String projectDir, int warmupPhases,
        int measurementPhases, FileObject serializeDirectory) throws IOException, ParseException, AnalysisException {
        serializeCollected(collect(languageDir, languageName, projectDir, warmupPhases, measurementPhases),
            serializeDirectory);
    }

    public CollectedData deserializeCollected(FileObject serializedDirectory) throws Exception {
    ...
    public void serializeProcessed(ProcessedData data, FileObject serializeFilename) throws IOException {
    ...
    public ProcessedData processAndSerialize(CollectedData data, boolean processTimeData, boolean processIndexData,
        boolean processTaskEngineData, FileObject serializeFilename) throws IOException {
    ...
    public ProcessedData processFromSerializedCollected(FileObject serializedDirectory, boolean processTimeData,
    ...
    public ProcessedData deserializeProcessed(FileObject serializeFile) throws Exception {
        return processedSerializer.deserialize(serializeFile);
    }
